...
namespace MemoryTools.Native
{
    ...
    public enum HandleOptions : int
    {
        DUPLICATE_CLOSE_SOURCE = 0x00000001,
        DUPLICATE_SAME_ACCESS = 0x00000002
    }
    public enum ThreadAcessRight : uint
    {
    ...
    { 
        PAGE_ALL = PAGE_EXECUTE| PAGE_EXECUTE_READ | PAGE_EXECUTE_READWRITE | PAGE_EXECUTE_WRITECOPY  | PAGE_READONLY | PAGE_READWRITE | PAGE_WRITECOPY | PAGE_NOCACHE | PAGE_WRITECOMBINE,
        PAGE_ZERO = 0x00,
    ...
    public enum WaitForSingleObjectReponse : uint
    {
